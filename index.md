...
### [show me the code!](https://github.com/jp-mess/VAE-Color-Balance)
...
**More background info:** [I've added a detailed results gallery here](https://jp-mess.github.io/Advanced-ML-Color-Fixes/2023/04/29/Introduction.html), which includes a lengthy introduction to basic computational photography, and a comparison of "easy" versus "difficult" lighting problems.
<br>
<br>
...
**Do we really need the VAE?** Technically, no. You could skip the encoding / decoding steps, and train a U-net to balance the [224 x 224 x 3] sized images directly, and I did try this (using the same dataset). However, this comes with an obvious disadvantage (runtime), as well as a not-so-obvious disadvantage, which is lack of regularization. In this analysis section, I'll call the latent balancer the 28-Net, and the direct balancer the 244-Net. 
