...
**Prove it.** I dislike it when people add complexity or "novel techniques" to algorithms that don't need them. So, I will do my best to convince you that I have not done that. For comparison, I used the same dataset to train a "direct Unet", which simply rebalances the images in their original format. Here were my observations:
